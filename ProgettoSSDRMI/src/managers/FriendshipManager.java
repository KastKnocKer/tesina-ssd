 ...
 * 
 * Questa classe ha in realtà lo scopo di fungere da interfaccia con 
...
public class FriendshipManager {
	...
	/**
	 * Richiede l'amicizia ad un altro contatto. In realtà, 
...
//		
		...
		/* In realtà è stato inviato il solo tentativo di richiesta, a questo punto non è certo */
